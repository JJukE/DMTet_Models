...
class ImageFolderDataset(Dataset):
    def __init__(
        ...
        if data_camera_mode in ["shapenet_car", "shapenet_chair", "shapenet_motorbike", \
            "renderpeople", "ts_house", "ts_animal"]:
    ...
    def __getitem__(self, idx):
        ...
        if self.data_camera_mode in ['shapenet_car', 'shapenet_chair', 'shapenet_motorbike', \
            'renderpeople', 'ts_house', 'ts_animal']:
